...
//   await fetch("https://coaching-website-backend-0nk3.onrender.com/api/hero", {
//     method: "POST",
//     headers: {
...
export default function HeroManager() {
  ...
  // Load existing hero data into form on mount
  useEffect(() => {
    fetch(API)
      .then(res => res.json())
      .then(data => {
  ...
  const saveHero = async () => {
  // Exclude imageFile — it can't be JSON serialized
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { imageFile: _imageFile, ...payload } = hero
